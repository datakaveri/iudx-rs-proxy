...
def on_request(ch, method, props, body):
    ...
    dictionary = {'adapter':'surat-itms','correlation_id':props.correlation_id, 'reply_to_queue':props.reply_to, 'id':'requestId','response':requestJson}
...
channel.basic_consume(queue='rpc_surat-itms', on_message_callback=on_request)
