 ...
 * iudx.rs.proxy.databroker.DatabrokerVerticle,iudx.rs.proxy.server.authenticator.AuthenticationVerticle
 * </i>
 */
public class Deployer {
  ...
  public static void main(String[] args) {
    CLI cli =
        CLI.create("IUDX Rs")
            .setSummary("A CLI to deploy the resource proxy server")
            .addOption(
                new Option()
                    .setLongName("help")
                    .setShortName("h")
