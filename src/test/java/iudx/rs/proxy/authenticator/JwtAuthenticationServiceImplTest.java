...
class JwtAuthenticationServiceImplTest {
  ...
  */
    ...
    public void successTokenInterospect(VertxTestContext testContext) {
        ...
        when(cacheServiceMock.get(any())).thenReturn(Future.succeededFuture(new JsonObject().put("value", "2021-06-09T12:52:37")
                .put("accessPolicy", "OPEN")));

        jwtAuthenticationService.tokenIntrospect(new JsonObject(), authInfo, jwtData, ar -> {
            if (ar.succeeded()) {
