...
public class NGSILDQueryParamsTest {
    ...
    @ParameterizedTest
    @ValueSource(strings = {JSON_MAXDISTANCE, NGSILDQUERY_MINDISTANCE})
    ...
    public void test_create_with_json_input(String distance, VertxTestContext vertxTestContext) throws URISyntaxException {
        ...
        jsonObject.put(NGSLILDQUERY_Q, "Dummy textQuery");
        ...
        assertEquals("TemporalRelation [endTime=Dummy endtime value, timeRel=Dummy timerel value, time=Dummy time value]"
